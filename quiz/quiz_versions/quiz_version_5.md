...
## Q3. Come si può ottenere il polimorfismo a runtime in Java?
...
## Q6. Quali lettere verranno stampate all'esecuzione del seguente programma?
...
## Q7. Quale modificatore di accesso applica l'incapsulamento impedendo l'accesso diretto alle proprietà di una classe dall'esterno della classe (eccetto attraverso i metodi della classe stessa)?
...
## Q8. La programmazione orientata agli oggetti è un paradigma in cui i programmi sono organizzati attorno a \_ e dati, piuttosto che a \_ e logica.
...
## Q9. Quale firma del metodo definisce la funzione chiamata?
...
## Q10. Il sistema di runtime avvia il tuo programma chiamando per prima quale funzione?
...
## Q12. Quante volte, questo programma, stamperà `"Hello World!"`?
...
## Q16. Qual è l'espressione più affidabile per testare se i valori di due variabili di tipo `String` sono uguali?
