...
## Q1. Perché l'affermazione *"Una classe anonima richiede un costruttore senza argomenti"* è falsa?
...
## Q5. Quali lettere verranno stampate all'esecuzione del seguente programma?
...
## Q8. Come si scrive un ciclo for-each che itera su ArrayList\<Pencil\>pencilCase?
...
## Q9. Il sistema di runtime avvia il tuo programma chiamando per prima quale funzione?
...
## Q11. Quale codice useresti nel Costruttore A per chiamare il Costruttore B?
...
## Q12. Qual è l'espressione più affidabile per testare se i valori di due variabili di tipo `String` sono uguali?
...
## Q13. Completa il codice per verificare se `number` è divisibile per `5`:
...
## Q14. Quale modificatore di accesso applica l'incapsulamento impedendo l'accesso diretto alle proprietà di una classe dall'esterno della classe (eccetto attraverso i metodi della classe stessa)?
...
## Q15. Quale modificatore rende una variabile immutabile in Java?
...
## Q16. Quale istruzione restituisce true se "firstName" è di tipo String?
